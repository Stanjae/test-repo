    ...
    <main className=" h-screen flex items-center justify-center flex-col gap-5">
      ...
      <div>
        ...
        <p>
          ...
          back to a branch. If you want to create a new branch to retain commits
          you create, you may do so (now or later) by using -c with the switch
          command. Example: git switch -c{" "}
        </p>
      </div>
    </main>
  );
